...
export default function Home() {
  ...
  // MASTER LIST: We use draftOrder to find the true original rank of players
  // This assumes draftOrder reflects the initial big board order.
  const getStaticRank = (player: Player) => {
    // If you have an originalPlayers array in your hook, use that instead.
    // Otherwise, we calculate based on the index in the current pool + drafted count
    // to maintain the "Big Board" feel.
